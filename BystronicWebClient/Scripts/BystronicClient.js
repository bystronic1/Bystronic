 ...
 /////////////////////////////    G R I D  C O L U M N S   /////////////////////////////////////////////////////////////////////////
    ...
    $scope.getAllAvailableColumns = function () {
        var columns = $scope.IsCanadianVersion
            ? ['PONumber', 'SalesOrder', 'Template', 'Customer', 'OrderDate', 'EstimatedShipDate', 'FinalPaymentDate', 'SalesmanName', 'CostCenter', 'TotalListPrice', 'ToolingPrice', 'SalePrice', 'DiscountAmount', 'DiscountPercent']
            : ['PONumber', 'SalesOrder', 'Template', 'Customer', 'OrderDate', 'EstimatedShipDate', 'FinalPaymentDate', 'SalesmanName', 'CostCenter', 'RegionalManagerName', 'RSMCostCenter', 'TotalListPrice', 'ToolingPrice', 'SalePrice', 'DiscountAmount', 'DiscountPercent'];
    ...
    $scope.availableColumns = [
        ...
        { ID: 'ToolingPrice', Name: 'Tooling Price' }
    ];
